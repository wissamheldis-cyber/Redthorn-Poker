    ...
    >
      ...
      <section id="mentors" className="px-8 lg:px-14 max-w-7xl mx-auto py-28">
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-4 mt-6">
          {[
            { img: "Gemini_Generated_Image_jjvoczjjvoczjjvo", name: "La Stoïque",      role: "Sang-froid" },
            ...
            { img: "Gemini_Generated_Image_njn49onjn49onjn4", name: "Le Lecteur",      role: "Psychologie" },
            { img: "Gemini_Generated_Image_91gbc91gbc91gbc9", name: "Le Chaos",        role: "Variance" },
          ].map(({ img, name, role }) => (
            <div
              key={name}
